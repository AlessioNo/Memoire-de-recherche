"""
Random Forest -- horizon 12 mois.

Lancement, depuis la RACINE du projet :

    python scripts/entrainer/random_forest_h12.py
...
Fichiers produits (chemins engendres par chemins.py) :
  - modeles/modele_random_forest_h12.pkl      (modele de la DERNIERE fenetre)
  - outputs/predictions_random_forest_h12.parquet
  - outputs/resultats_random_forest_h12.parquet
  - outputs/resultats_random_forest_par_fenetre_h12.parquet
  - 1 ligne dans outputs/journal_experiences.parquet  (sans doublon)
  - le rapport '14_horizon_random_forest' (outputs/rapports/), lu par notebooks/11_horizon_12_mois.ipynb
"""
...
if __name__ == "__main__":
    boucle.lancer(specs.RANDOM_FOREST, horizon=12)
