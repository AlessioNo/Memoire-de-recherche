"""
Elastic Net -- horizon 12 mois.

Lancement, depuis la RACINE du projet :

    python scripts/entrainer/elastic_net_h12.py
...
Fichiers produits (chemins engendres par chemins.py) :
  - modeles/modele_elastic_net_h12.pkl        (modele de la DERNIERE fenetre)
  - outputs/predictions_elastic_net_h12.parquet
  - outputs/resultats_elastic_net_h12.parquet
  - outputs/resultats_elastic_net_par_fenetre_h12.parquet
  - 1 ligne dans outputs/journal_experiences.parquet  (sans doublon)
  - le rapport '12_horizon_elastic_net' (outputs/rapports/), lu par notebooks/11_horizon_12_mois.ipynb
"""
