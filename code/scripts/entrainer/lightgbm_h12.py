"""
LightGBM -- horizon 12 mois.

Lancement, depuis la RACINE du projet :

    python scripts/entrainer/lightgbm_h12.py
...
Fichiers produits (chemins engendres par chemins.py) :
  - modeles/modele_lightgbm_h12.pkl           (modele de la DERNIERE fenetre)
  - outputs/predictions_lightgbm_h12.parquet
  - outputs/resultats_lightgbm_h12.parquet
  - outputs/resultats_lightgbm_par_fenetre_h12.parquet
  - 1 ligne dans outputs/journal_experiences.parquet  (sans doublon)
  - le rapport '13_horizon_lightgbm' (outputs/rapports/), lu par notebooks/11_horizon_12_mois.ipynb
"""
